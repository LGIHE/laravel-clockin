        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">Manage organizational departments</p>
                </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($departments as $department)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-900">{{ $department->description ?: 'N/A' }}</div>
                                </td>
                        ...
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <div class="mt-2">
                                    ...
                                    @if($selectedDepartment->users_count > 0)
                                        <p class="mt-2 text-sm text-red-600 font-medium">
                                            This department has {{ $selectedDepartment->users_count }} active user(s) and cannot be deleted.
                                        </p>
                                    @else
